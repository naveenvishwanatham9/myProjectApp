...
<table>
<h3 style="text-align: center;color: red;">WELCOME TO WH TYPE EDIT PAGE </h3>

<form:form action="update" method="post" modelAttribute="whType">

<tr><td style="color:purple"> User Type:</td> <td> <form:radiobutton path="userType" value="vendor" />Vendor
...
<tr><td style="text-align:center;color:green;"><input type="submit" value="UPDATE USER"/></td></tr><td>
